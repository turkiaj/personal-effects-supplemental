...
saveRDS(eval.mat, "evals/RHS-insample-eval.rds")
summary.mat <- rbind(summary.mat, eval.mat)

eval.mat <- mebn_rep_accuracy("no-RHS" ,"BLMM_gamma/ar1/", amount_of_subjects = length(levels(sysdimet$SUBJECT_ID)), assumedtargets)
saveRDS(eval.mat, "no-RHS-insample-eval.rds")
summary.mat <- rbind(summary.mat, eval.mat)
