...
As an example, we analyze a dataset from the Sysdimet study [@pmid21901116] that contains repeated measurements of 17 nutrients, some basic information about patients (gender, medication) and their corresponding blood test results. 
...
mse.mat <- rbind(mse.mat, c("No-RHS", round(colMeans(personal_mse), 2), round(model_mse, 2)))
...
model_mse <- mean(colMeans(personal_mse))
mse.mat <- rbind(mse.mat, c("RHS", round(colMeans(personal_mse), 2), round(model_mse, 2)))
