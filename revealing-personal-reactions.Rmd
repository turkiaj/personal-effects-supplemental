...
# TODO: kerää matkan varrelta matriisiin vertailuja ja näytä lopuksi tulos

saveRDS(mse.mat, "evaluations/MSE-matrix.rds")
mse.mat <- readRDS(file="evaluations/MSE-matrix.rds")
...
target_models_dirs <- assumedtargets
target_models_dirs$modelcache <- "models/BLMM_gamma/ar1"
target_models_dirs[target_models_dirs$Name=="fsins",]$modelcache <- "models/BLMM_normal/ar1"

initial_graph <- mebn.new_graph_with_randomvariables(datadesc)
sysdimet_expfam_ar1 <- mebn.bipartite_expfam_bn(initial_graph, assumedpredictors, assumedtargets, target_models_dirs)
...
source("mebn/MEBN.r")
require(igraph)
sysdimet_gamma_ar1 <- read_graph("graphs/sysdimet_gamma_ar1.graphml", "graphml")
