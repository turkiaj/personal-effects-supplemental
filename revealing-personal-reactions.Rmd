...
hdlplot <- ggplot() +
  ...
  scale_x_discrete(limits=c(-1,0,3,4,7,8,11,12)) +
...
#  geom_rect(aes(xmin=3, xmax=4, ymin=0.5, ymax=Inf)) + 
...
Next, we contruct a EXPFAM AR(1) model that has this normally distributed fsins-response and otherwise Gamma distributed blood concenration responses. PPC of this combined model is then
