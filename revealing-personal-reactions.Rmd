...
Following table summarizes the prediction accuracy with mean squared error 
...
```{r, typical_effects_figure, fig.height = 6, fig.width = 7, echo=FALSE, fig.align = "left", message=FALSE, warning=FALSE, cache=FALSE}
source("mebn/MEBN.r")
require(igraph)
...
personal_graph1 <- mebn.personal_graph(person_id = 1, 
