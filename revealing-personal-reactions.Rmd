...
class.df$Concentration <- gsub("fshdl", "fS-HDL", class.df$Concentration)
class.df$Concentration <- gsub("fsldl", "fS-LDL", class.df$Concentration)
class.df$Concentration <- gsub("fsins", "fS-Ins", class.df$Concentration)
class.df$Concentration <- gsub("fskol", "fS-Chol", class.df$Concentration)
class.df$Concentration <- gsub("fpgluk", "fP-Gluc", class.df$Concentration)
...
effects_table.df$Variance <- ordered_typical_effects$variance

kable(effects_table.df, booktabs = T) %>%
  kable_styling(latex_options = c("basic", "condensed"), full_width = FALSE) %>%
  row_spec(0,bold=TRUE) 
