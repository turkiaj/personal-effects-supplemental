...
Let us denote the graph of interconnected nutrients and blood concentrations with $G$. We can then formulate the modeling problem as finding the graph $G$ that is the most probable given the data $D$
