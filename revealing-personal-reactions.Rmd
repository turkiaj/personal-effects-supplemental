...
# add non-shrinked evaluation in same table
...
percent_nonrhs.mat <- summary.mat/number_of_preds * 100

percent_nonrhs.mat <- cbind(percent_nonrhs.mat, rowMeans(percent_nonrhs.mat[,1:3]))
...
summary.mat
percent_pred.mat <- summary.mat/number_of_preds * 100

percent_pred.mat <- cbind(percent_pred.mat, rowMeans(percent_pred.mat[,1:3]))
colnames(percent_pred.mat) <- c('0 to 4 weeks', '4 to 8 weeks', '8 to 12 weeks', 'avg. 12 week change', 'avg. change acc.')

percent_pred.mat <- round(percent_pred.mat, 0)
percent_pred.mat
```
