...
```{r spagettiplot_fshdl, eval = TRUE, echo=FALSE, fig.align="left", fig.height=2, fig.width=5, message=FALSE}
# Fig. 1 in article
...
```{r gamma_ar1_rhs_ppc, echo=FALSE, fig.height = 4, fig.width=5, message=FALSE, warning=FALSE, eval=TRUE, cache=TRUE}
...
```{r expfam_ar1_rhs_ppc, echo=FALSE, fig.height = 5, fig.width=5,fig.align = "left", message=FALSE, warning=FALSE, eval=TRUE, cache=FALSE}
source("mebn/MEBN.r")
